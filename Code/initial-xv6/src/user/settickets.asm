...
int main(int argc, char *argv[]) {
  ...
  14:	85058593          	addi	a1,a1,-1968 # 860 <malloc+0xe6>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	674080e7          	jalr	1652(ra) # 68e <fprintf>
        exit(1);
  22:	4505                	li	a0,1
  ...
  32:	1f2080e7          	jalr	498(ra) # 220 <atoi>
  36:	84aa                	mv	s1,a0

    // Call the syscall directly
    int result = settickets(tickets);
  38:	00000097          	auipc	ra,0x0
  3c:	394080e7          	jalr	916(ra) # 3cc <settickets>

    if(result == -1){
  40:	57fd                	li	a5,-1
  42:	02f50563          	beq	a0,a5,6c <main+0x6c>
  ...
  4a:	356080e7          	jalr	854(ra) # 39c <getpid>
  4e:	85aa                	mv	a1,a0
  50:	8626                	mv	a2,s1
  52:	00001517          	auipc	a0,0x1
  56:	86e50513          	addi	a0,a0,-1938 # 8c0 <malloc+0x146>
  5a:	00000097          	auipc	ra,0x0
  5e:	662080e7          	jalr	1634(ra) # 6bc <printf>
    exit(0);
  62:	4501                	li	a0,0
  64:	00000097          	auipc	ra,0x0
  68:	2b8080e7          	jalr	696(ra) # 31c <exit>
        fprintf(2, "Could not set tickets to %d for process with pid %d\n", tickets, getpid());
  6c:	00000097          	auipc	ra,0x0
  70:	330080e7          	jalr	816(ra) # 39c <getpid>
  74:	86aa                	mv	a3,a0
  76:	8626                	mv	a2,s1
  78:	00001597          	auipc	a1,0x1
  7c:	81058593          	addi	a1,a1,-2032 # 888 <malloc+0x10e>
  80:	4509                	li	a0,2
  82:	00000097          	auipc	ra,0x0
  86:	60c080e7          	jalr	1548(ra) # 68e <fprintf>
        exit(1);
  8a:	4505                	li	a0,1
  8c:	00000097          	auipc	ra,0x0
  90:	290080e7          	jalr	656(ra) # 31c <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42c:	4c050513          	addi	a0,a0,1216 # 8e8 <digits>
 430:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	3f4b8b93          	addi	s7,s7,1012 # 8e8 <digits>
 ...
 638:	2ac90913          	addi	s2,s2,684 # 8e0 <malloc+0x166>
        while(*s != 0){

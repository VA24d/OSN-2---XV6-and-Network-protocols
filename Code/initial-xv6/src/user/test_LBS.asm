...
int main(int argc, char *argv[]) {
  ...
  16:	8be58593          	addi	a1,a1,-1858 # 8d0 <malloc+0xe4>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	6e4080e7          	jalr	1764(ra) # 700 <fprintf>
        exit(1);
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	368080e7          	jalr	872(ra) # 38e <exit>
    }

    int num_children = atoi(argv[1]);
  2e:	6588                	ld	a0,8(a1)
  30:	00000097          	auipc	ra,0x0
  34:	262080e7          	jalr	610(ra) # 292 <atoi>
  38:	892a                	mv	s2,a0

    for(int i = 0; i < num_children; i++){
  3a:	02a05a63          	blez	a0,6e <main+0x6e>
  3e:	4481                	li	s1,0
  40:	a011                	j	44 <main+0x44>
  42:	84be                	mv	s1,a5
        int pid = fork();
  44:	00000097          	auipc	ra,0x0
  48:	342080e7          	jalr	834(ra) # 386 <fork>
        if(pid < 0){
  4c:	02054663          	bltz	a0,78 <main+0x78>
            fprintf(2, "Fork failed\n");
            exit(1);
        }
        if(pid == 0){
  50:	c131                	beqz	a0,94 <main+0x94>
    for(int i = 0; i < num_children; i++){
  52:	0014879b          	addiw	a5,s1,1
  56:	fef916e3          	bne	s2,a5,42 <main+0x42>
  5a:	4901                	li	s2,0
        }
    }
  ...
  62:	338080e7          	jalr	824(ra) # 396 <wait>
    for(int i = 0; i < num_children; i++){
  66:	87ca                	mv	a5,s2
  68:	2905                	addiw	s2,s2,1
  6a:	fef499e3          	bne	s1,a5,5c <main+0x5c>
    }
  ...
  7c:	88058593          	addi	a1,a1,-1920 # 8f8 <malloc+0x10c>
  80:	4509                	li	a0,2
  82:	00000097          	auipc	ra,0x0
  86:	67e080e7          	jalr	1662(ra) # 700 <fprintf>
            exit(1);
  8a:	4505                	li	a0,1
  ...
  94:	478d                	li	a5,3
  96:	02f4e4bb          	remw	s1,s1,a5
  9a:	2485                	addiw	s1,s1,1
            if(settickets(tickets) == -1){
  9c:	8526                	mv	a0,s1
  9e:	00000097          	auipc	ra,0x0
  a2:	3a0080e7          	jalr	928(ra) # 43e <settickets>
  a6:	57fd                	li	a5,-1
  a8:	02f50b63          	beq	a0,a5,de <main+0xde>
            printf("Child %d: Tickets set to %d\n", getpid(), tickets);
  ac:	00000097          	auipc	ra,0x0
  b0:	362080e7          	jalr	866(ra) # 40e <getpid>
  b4:	85aa                	mv	a1,a0
  b6:	8626                	mv	a2,s1
  b8:	00001517          	auipc	a0,0x1
  bc:	87850513          	addi	a0,a0,-1928 # 930 <malloc+0x144>
  c0:	00000097          	auipc	ra,0x0
  c4:	66e080e7          	jalr	1646(ra) # 72e <printf>
  c8:	05f5e7b7          	lui	a5,0x5f5e
  cc:	10078793          	addi	a5,a5,256 # 5f5e100 <base+0x5f5d0f0>
            for(int j = 0; j < 100000000; j++); // Busy loop
  d0:	37fd                	addiw	a5,a5,-1
  d2:	fffd                	bnez	a5,d0 <main+0xd0>
            exit(0);
  d4:	4501                	li	a0,0
  d6:	00000097          	auipc	ra,0x0
  da:	2b8080e7          	jalr	696(ra) # 38e <exit>
                fprintf(2, "Child %d: Could not set tickets to %d\n", getpid(), tickets);
  de:	00000097          	auipc	ra,0x0
  e2:	330080e7          	jalr	816(ra) # 40e <getpid>
  e6:	862a                	mv	a2,a0
  e8:	86a6                	mv	a3,s1
  ea:	00001597          	auipc	a1,0x1
  ee:	81e58593          	addi	a1,a1,-2018 # 908 <malloc+0x11c>
  f2:	4509                	li	a0,2
  f4:	00000097          	auipc	ra,0x0
  f8:	60c080e7          	jalr	1548(ra) # 700 <fprintf>
                exit(1);
  fc:	4505                	li	a0,1
  fe:	00000097          	auipc	ra,0x0
 102:	290080e7          	jalr	656(ra) # 38e <exit>
...
putc(int fd, char c)
{
 ...
 46c:	f46080e7          	jalr	-186(ra) # 3ae <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49e:	4be50513          	addi	a0,a0,1214 # 958 <digits>
 4a2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 56a:	3f2b8b93          	addi	s7,s7,1010 # 958 <digits>
 ...
 6aa:	2aa90913          	addi	s2,s2,682 # 950 <malloc+0x164>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8c4:	b56080e7          	jalr	-1194(ra) # 416 <sbrk>
  if(p == (char*)-1)
